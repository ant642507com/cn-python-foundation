...
# TODO 计算矩阵的转置
def transpose(m):
    # 参考：https://docs.python.org/dev/tutorial/controlflow.html#unpacking-argument-lists
...
#     0 & -\frac{7}{3} & -\frac{11}{3} & \frac{11}{9} \\
#     0 & -6 & -6 & 1 \end{bmatrix}$
#     
# $ --> \begin{bmatrix}
#     1 & 0 & -\frac{2}{3} & \frac{1}{6} \\
#     0 & 1 & 1 & \frac{1}{6} \\
#     0 & 0 & -\frac{4}{3} & \frac{5}{6} \end{bmatrix}$
#     
# $ --> \begin{bmatrix}
#     1 & 0 & 0 & -\frac{1}{4} \\
#     0 & 1 & 0 & \frac{11}{24} \\
#     0 & 0 & 1 & -\frac{5}{8} \end{bmatrix}$
...
# 
# $ --> \begin{bmatrix}
#     1 & -\frac{1}{2} & -\frac{5}{3} & \frac{1}{6} \\
#     0 & 3 & \frac{44}{3} & \frac{1}{3} \\
#     0 & -\frac{3}{2} & -\frac{22}{3} & \frac{11}{6} \end{bmatrix}$
#     
# $ --> \begin{bmatrix}
#     1 & 0 & \frac{7}{9} & \frac{2}{9} \\
#     0 & 1 & \frac{44}{9} & \frac{1}{9} \\
#     0 & 0 & 0 & 2 \end{bmatrix}$
#     
